...
# Generated on: Sun Feb 15 05:12:06 CST 2026 (Sun Feb 15 11:12:06 UTC 2026)
...
set logfile fv/systolic_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/systolic_top -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../sources/mac_unit.sv ../sources/processing_element.sv ../sources/systolic_array_4x4.sv ../sources/input_skew_controller.sv ../sources/systolic_controller.sv ../sources/systolic_top.sv
elaborate_design -golden -root {systolic_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/systolic_top/fv_map.v.gz
elaborate_design -revised -root {systolic_top}
...
set_analyze_option -mapping_file fv/systolic_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.systolic_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.systolic_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.systolic_top.rtl.fv_map.rpt
