...
# Generated on: Sun Feb 15 23:57:46 CST 2026 (Mon Feb 16 05:57:46 UTC 2026)
...
set logfile fv/systolic_top_ARRAY_SIZE8/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/systolic_top_ARRAY_SIZE8 -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_AO_LVT_TT_nldm_211120.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_AO_SLVT_TT_nldm_211120.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_INVBUF_LVT_TT_nldm_220122.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_INVBUF_SLVT_TT_nldm_220122.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_OA_LVT_TT_nldm_211120.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_OA_SLVT_TT_nldm_211120.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_SEQ_LVT_TT_nldm_220123.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_SEQ_SLVT_TT_nldm_220123.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_SIMPLE_LVT_TT_nldm_211120.lib \
    /home/kevinlevin/Projects/Neural_Network_Accelerator/synthesis/../lib/asap7sc7p5t_SIMPLE_SLVT_TT_nldm_211120.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/mac_unit.sv ../rtl/processing_element.sv ../rtl/systolic_array_4x4.sv ../rtl/input_skew_controller.sv ../rtl/systolic_controller.sv ../rtl/systolic_top.sv
elaborate_design -golden -root {systolic_top} -rootonly -rootonly  -parameter -int {ARRAY_SIZE} "8"

read_design -verilog95   -revised -lastmod -noelab fv/systolic_top_ARRAY_SIZE8/fv_map.v.gz
elaborate_design -revised -root {systolic_top_ARRAY_SIZE8}
...
set_analyze_option -mapping_file fv/systolic_top_ARRAY_SIZE8/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.systolic_top_ARRAY_SIZE8.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.systolic_top_ARRAY_SIZE8.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.systolic_top_ARRAY_SIZE8.rtl.fv_map.rpt
