...
# IMPORTANT: With 0ps slack at 1000ps, P&R will likely fail timing.
# Recommended: use 1200ps for ~200ps routing margin, tighten later.
set CLK_PERIOD 1200  ;# picoseconds (1200ps = 833 MHz with P&R margin)
